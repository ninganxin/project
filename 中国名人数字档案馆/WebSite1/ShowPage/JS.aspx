<%@ Page Language="C#" AutoEventWireup="true" CodeFile="JS.aspx.cs" Inherits="t" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="m-padded-large">
            <div class="ui container">
                ...
                <div class="ui attached segment">
                    <div>
                        <a href="#" class="ui teal basic teal button">军事家</a>
                    </div>
                </div>
                ...
                <!--档案列表-->
                <div class="ui attached segment">
                    <div class="ui container m-margin-tb-big">
                        <h2 class="ui teal header item">人物档案</h2>
                    </div>
                    <div class="ui attached segment">
